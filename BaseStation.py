...
my_image = customtkinter.CTkImage(
    light_image=Image.open("connecteddrone.jpg"), size=(215, 70)
)
...
def setDroneName():
    ...
    app.optionmenu_1.configure(
        command=lambda x: updateDroneNames(),
        values=[
            droneName0,
            droneName1,
            droneName2,
...
def manualControl():
    ...
    while True:
        ...
        if controller:
            ...
            print(
                "\033[31m- - - - NO FLIGHTSTICK CONNECTED  |  CONNECT CONTROLLER AND RESTART - - - -\033[0m"
            )
            print(
                "\033[31m===========================================================================\033[0m"
            )
...
def listen(q_out, q_in):  # happens on a separate thread
    ...
    while True:
        ...
        strData = (
            addr[0] + "*" + str(addr[1]) + "*" + strData
        )  # the ip, the port, the message
...
def kill():
    ...
    app.radio_button_1.configure(
        fg_color="Red", text="Drone Killed", text_color="Red")
    app.radio_button_2.configure(
        fg_color="Red", text="Drone Killed", text_color="Red")
    app.radio_button_3.configure(
        fg_color="Red", text="Drone Killed", text_color="Red")
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.sidebar_button_2 = customtkinter.CTkButton(
            self.sidebar_frame, command=lambda: introToAP(), text="Connect To AP"
        )
        self.sidebar_button_2.grid(row=2, column=0, padx=20, pady=10)
        self.sidebar_button_3 = customtkinter.CTkButton(
            self.sidebar_frame, command=self.sidebar_button_event, text="Test"
        )
        self.sidebar_button_3.grid(row=3, column=0, padx=20, pady=10)
        self.sidebar_button_4 = customtkinter.CTkButton(
            self.sidebar_frame, command=self.sidebar_button_event, text="Quit"
        )
        self.sidebar_button_4.grid(row=4, column=0, padx=20, pady=10)

        self.my_label = customtkinter.CTkLabel(
            self, text="", height=70, width=210)
        ...
        self.entry = customtkinter.CTkEntry(
            self, placeholder_text="Manual UDP Console")
        self.entry.grid(
        ...
        self.textbox1.grid(row=0, column=1, padx=(
        ...
        self.tabview.tab("Control").grid_columnconfigure(
            0, weight=1
        )  # configure grid of individual tabs
        self.tabview.tab("Info").grid_columnconfigure(0, weight=1)

        self.optionmenu_1 = customtkinter.CTkOptionMenu(
            self.tabview.tab("Control"), dynamic_resizing=True
        )  # creates the optionmenu
        ...
        self.label_tab_2 = customtkinter.CTkLabel(
            self.tabview.tab("Info"), text="Ip, Port will be here"
        )
        ...
        self.label_radio_group = customtkinter.CTkLabel(
            master=self.radiobutton_frame, text="Mode and Stage Control:"
        )
        ...
        self.slider_2 = customtkinter.CTkSlider(
            self.slider_progressbar_frame, orientation="vertical", from_=1000, to=2000
        )
        self.slider_2.grid(
        ...
        self.scrollable_frame = customtkinter.CTkScrollableFrame(
            self, label_text="Main Swarm Communications"
        )
        ...
        for i in range(100):
            switch = customtkinter.CTkSwitch(
                master=self.scrollable_frame, text=f"Drone {i}"
            )
        ...
        self.sidebar_button_3.configure(
            command=lambda: addDrone(), text="Connect to Swarm"
        )
        ...
        self.seg_button_1.configure(
            values=["Sensitivity", "Throttle", "Max Range"])
    ...
    def open_input_dialog_event(self):
        dialog = customtkinter.CTkInputDialog(
            text="Enter a Direct UDP Drone Command:", title="Direct Command"
        )
